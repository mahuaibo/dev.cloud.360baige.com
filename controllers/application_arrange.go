...
type ApplicationArrangeController struct {
	beego.Controller
}
// @Title 应用商店分类接口
// @Description 应用商店分类接口
...
// @Param datatype query   string true       "类型(1,基础，2 热门  )"
// @Failure 400 {"code":400,"message":"..."}
// @router /get-app-arrange [post]
func (c *ApplicationArrangeController) GetAppArrange() {
	var reply Paginator
	res := Response{}
	...
	err := client.Call(beego.AppConfig.String("EtcdURL"), "ApplicationArrange", "List", args, &reply)
	if err != nil {
